...
it("generates css which only contains rules for HTML except global layer", async ({
  ...
  expect(files).toMatchInlineSnapshot(`
    ...
    ",
      "[intermediate] tailwindcss/@@/tests/entry.html/top.sj.js": "import "\\u0000tailwindcss/global.layer0.j.css";
    ...
    ",
      "[output] _virtual/top.sj.js": "/* empty css                    */
    /* empty css                      */
    /* empty css                    */
    ",
    ...
    <html lang="en">
      ...
      <script type="module" crossorigin src="/_virtual/top.sj.js"></script>
...
it("generates css without entry js", async ({ expect }) => {
  ...
  expect(files).toMatchInlineSnapshot(`
    ...
    <html lang="en">
      <head>
        <meta charset="UTF-8" />
        <title>Test Entry File</title>  <script type="module" crossorigin src="/_virtual/top.sj.js"></script>
      <link rel="stylesheet" crossorigin href="/_virtual/global.layer0.j.css">
      <link rel="stylesheet" crossorigin href="/_virtual/hoisted.layer1.sj.css">
      <link rel="stylesheet" crossorigin href="/_virtual/module.layer2.j.css">
    </head>
